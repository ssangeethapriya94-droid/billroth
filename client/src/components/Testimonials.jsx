      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
            Words From Our <span className="text-[#2f5aae]">Healed Patients</span>
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-slate-50 to-blue-50/50 rounded-3xl p-8 sm:p-12 lg:p-16 border border-slate-200/80 shadow-xl relative overflow-hidden">
            
            {/* Top Quote Icon */}
            <div className="absolute top-8 right-8 text-[#2f5aae]/10 pointer-events-none">
              <Quote size={80} />
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-slate-200/60">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-[#2f5aae] to-[#0095da] text-white flex items-center justify-center font-extrabold text-lg shadow-md">
            ...
            <div className="flex items-center justify-between pt-8 mt-8 border-t border-slate-200/60">
                ...
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`h-2.5 rounded-full transition-all duration-300 ${
                      i === current ? 'w-8 bg-[#2f5aae]' : 'w-2.5 bg-slate-300 hover:bg-slate-400'
                    }`}
              ...
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={prev}
                  className="w-11 h-11 rounded-full bg-white border border-slate-200 text-slate-700 hover:bg-[#2f5aae] hover:text-white hover:border-[#2f5aae] transition-all flex items-center justify-center shadow-sm"
